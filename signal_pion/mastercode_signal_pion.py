...
infile = TFile( '/eos/user/m/mmourad/HN_simulation/trees/signal_pion_mass'+sys.argv[1]+'_tree.root' )
...
h_pt_pi = TH1D("h_pt_pi","p_{T} of #pi^{#pm};p_{T} [GeV]",50,pion_pt_thr,100)
...
h_pt_neutrino = TH1D("h_pt_neutrino","p_{T} of #nu_{#tau};p_{T} [GeV]",150,0,30)
...
h_deltaR_mu2pi = TH1D("h_deltaR_mu2pi","#Delta R between #mu_{2} and #pi^{#pm};#Delta R", 45,0,1.5)
...
h_energy_tau = TH1D("h_energy_tau","Energy of #tau;E_{#tau} [GeV]",200, tau_energy_thr,1000)
