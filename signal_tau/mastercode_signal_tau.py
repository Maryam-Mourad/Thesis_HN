...
infile = TFile( '/eos/user/m/mmourad/HN_simulation/trees/signal_tau_mass'+sys.argv[1]+'_tree.root' )
...
h_m_HN = TH1D("h_m_HN", "Reconstructed Mass of HN(without neutrino) ; M [GeV]", 150, 0, M + 1)
